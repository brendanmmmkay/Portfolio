...
import momentPitch2 from "../image/momentPitch2.png"
import momentMeeting from "../image/momentMeeting.png"
import momentMoodboards2 from "../image/momentMoodboards2.png"
 ...
 */}
                        ...
                        <div className="max-w-2xl">
                            ...
                            <h2 className="text-stone-800 text-xxs font-SFpro pt-5">FEATURED ON</h2>
 ...
 */}
                ...
                <div className="flex flew-grow gap-4 px-4 pb-10">
                    ...
                    <TextBox header="PARTNERS" subtitle="Supply Agreements with Mercedes-Bens Energy and Nissan North America." />
                ...
                <div className="flex flew-grow gap-4 px-4 pb-10">
                    ...
                    <TextBox header="COMMUNITY" subtitle="We value our relationships, and always put people first. Our solutions are designed to be affordable, reliable, and socially responsible while thinking of our collective future. " />
 ...
 */}
      ...
      <p className="text-red-500 gap-24 bg-stone-400 max-w-48 right-1/3 font-bold mt-[30rem] z-0">This is a simple rectangle with backdrop blur</p>
      <div className="absolute inset-0 bg-white bg-opacity-30 mt-[32rem] right-32 rounded-full backdrop-blur-sm bottom-20 flex justify-center items-center z-10">
 ...
 */}
            ...
            <div className=" bg-white rounded-md mt-20">
                ...
                <div className="grid md:grid-cols-2">
                    <Paragraph
                        header="CHALLENGE: DESIGN FEEDBACK"
                        body1="Initially, my design meetings included the four founders, our marketing intern, and one electrical engineer. Often, certain founders would say less because they assumed that their opinion was already evident, or indecisiveness and continued discussion amongst my audience would eat up time and make individual opinions blurry."
                        body2="Sending each audience member a Google Form containing a set of more divisive questions allowed me to quickly obtain detailed individual responses."
                    ></Paragraph>
                ...
                <div className="grid md:grid-cols-2">
                    <Paragraph
                        header="MOOD BOARDS"
                        body1="I began by compiling precedent mood boards of competitors in the energy industry and discussing their design language to determine where moment could be unique. Next, I compiled examples of brands that resonated with the founders and drew attention to how they leveraged colour, typography, and expressive elements. I then asked the founders to determine which mode of expression they preferred most."
                        body2="Finally, I created four distinctly different mood boards, each following the approach of a direction whose values I defined through feedback from the founders. After their deliberation they settled on choosing the bottom right mood board, however, there were plenty of elements to adjust."
                    ></Paragraph>

                    <div className="px-4 object-cover pb-4 rounded-8 items-end py-8">
                        <Image className=""
                            src={momentMoodboards2}
                        />
                    </div>
                </div>
