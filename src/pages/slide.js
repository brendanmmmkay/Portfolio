...
export default function Home() {
  return (
    ...
    <div classname="bg-conversly_color-blush absolute -ml-6 h-4/6 w-full md:h-2/6 lg:mt-40 lg:h-3/6"></div>
...
<div className="h-96">
  ...
  <div classname="relative z-10" id="relative">
    <header>
      <div classname="absolute top-0 z-50 w-full sm:px-12 mx-auto flex items-center justify-between py-4 shadow-2xl bg-opacity-10">
        ...
        <div classname="overflow-hidden relative h-64 md:h-96">
          <div classname="duration-700 ease-in-out absolute inset-0 transition-all transform translate-x-0 z-20"
            ...
            <img src="https://images.pexels.com/photos/315938/pexels-photo-315938.jpeg"
              ...
              <div classname="absolute top-1/2 lg:left-1/3 md:h-1/4 left-1/4 text-white font-bold md:text-4xl sm:text-2xl text-center">Fast & Easy Booking</div>
          </div>
          <div classname="duration-700 ease-in-out absolute inset-0 transition-all transform translate-x-full z-10"
            ...
            <img src="https://images.pexels.com/photos/4489729/pexels-photo-4489729.jpeg"
              classname="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..."/>
              <div classname="absolute top-1/2 lg:left-1/3 md:h-1/4 left-1/4 text-white font-bold md:text-4xl sm:text-2xl text-center">Many Pickup Location</div>
          </div>
          <div classname="hidden duration-700 ease-in-out absolute inset-0 transition-all transform" data-carousel-item="">
            <img src="https://images.pexels.com/photos/4488654/pexels-photo-4488654.jpeg"
              classname="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..."/>
              <div classname="absolute top-1/2 lg:left-1/3 md:h-1/4 left-1/4 text-white font-bold md:text-4xl sm:text-2xl text-center">Statified Customers</div>
          </div>
          <div classname="hidden duration-700 ease-in-out absolute inset-0 transition-all transform" data-carousel-item="">
            <img src="https://images.pexels.com/photos/4489732/pexels-photo-4489732.jpeg"
              classname="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..."/>
              <div classname="absolute top-1/2 lg:left-1/3 md:h-1/4 left-1/4 text-white font-bold md:text-4xl sm:text-2xl text-center">Advanced Engine Services</div>
          </div>
          <div classname="duration-700 ease-in-out absolute inset-0 transition-all transform -translate-x-full z-10"
            data-carousel-item="">
            <img src="https://images.pexels.com/photos/6872599/pexels-photo-6872599.jpeg"
              classname="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..."/>
              <div classname="absolute top-1/2 lg:left-1/3 md:h-1/4 left-1/4 text-white font-bold md:text-4xl sm:text-2xl text-center">Professional Car Wash</div>
          </div>
        </div>
        <div classname="flex absolute bottom-5 left-1/2 z-30 space-x-3 -translate-x-1/2">
          <button type="button" classname="w-3 h-3 rounded-full bg-white dark:bg-gray-800" aria-current="true"
