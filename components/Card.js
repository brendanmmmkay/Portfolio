    ...
    return (
        ...
        <p className="hidden md:block text-1xl z-80 font-Avenir">{subTitle}</p>
                        ...
                        <div className="grid">
                            ...
                            <div className="md:flex flex-col justify-end items-end pr-10">
                                <button className="hidden md:block bg-white hover:bg-regal-gray font-Avenir text-1xl text-stone-800 hover:text-stone-200 border border-edge-white py-4 px-4 w-60 h-16">
                                    View Case Study
                                </button>
                            </div>
                        ...
                        <div className='py-4 pl-4 md:p-4 flex flex-row text-nowrap overflow-x-scroll no-scrollbar gap-4 lg:col-span-3'>
