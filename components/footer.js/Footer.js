    ...
    return (
        ...
        >
            ...
            <div className="">
                ...
                <h2 className="text-stone-300 font-SFpro text-xxs gap-10 pt-0">HELPED SECURE $200, 000 IN INVESTMENTS THROUGH PITCH DECK DESIGN FOR A NATIONAL PITCH COMPETITION FOR MOMENT ENERGY.
                </h2>
                <h2 className="text-stone-300 font-SFpro text-xxs gap-10 pt-0"> 
