      ...
      <div className="py-2 bg-white outline-2"> {/* Add padding/margin for large screens */}
        <ul className="flex justify-between items-center">
          ...
          <div className="justify-end pt-1">
            ...
            <Link href={"https://www.linkedin.com/in/brendan-mckay/"}>
              <button className="group text-chip-deep-gray borderColor-off-white font-AvenirMedium relative h-8 overflow-hidden text-xs tracking-wider text-toverflow-x-hidden rounded-full bg-white px-8 py-1 cursor-pointer text-neutral-750"><span className="relative z-10">BPMCKAY@SFU.CA</span><span className="absolute inset-0 overflow-hidden rounded-md"><span className="absolute left-0 aspect-square w-full origin-center -translate-x-full text-stone-700 rounded-full bg-off-white transition-all duration-500 group-hover:-translate-x-0 group-hover:scale-150"></span></span></button>
            </Link>
          </div>
        </ul>
      </div>
