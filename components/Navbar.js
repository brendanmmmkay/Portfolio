...
export default function Navbar() {
  return (
    <nav className="hidden md:block fixed z-50 w-full">
      <div className=" bg-white"> {/* Add padding/margin for large screens */}
        <ul className="grid grid-cols-3">
          <div className="px-4">
          <Link href="/">
          {/* <Image className="invisible md:visible scale-125" src={wordMark} /> */}
          <li className="text-xxs font-AvenirHeavy text-stone-600 py-2">BRENDAN MCKAY</li>
          </Link>
          </div>
          ...
          <Link href="/Brendan_McKay_Resume_2024.pdf" target="_blank" rel="noopener noreferrer">
            ...
            <button className="text-xxs font-SFpro text-chip-deep-gray pr-10">RESUME</button>
            </Link>
            <Link href={"https://www.linkedin.com/in/brendan-mckay/"}>
              ...
              <button className="text-xxs font-SFpro text-chip-deep-gray pr-10">LINKEDIN</button>
            </Link>
            {/* <Link href="/Brendan_McKay_Resume_2024.pdf" target="_blank" rel="noopener noreferrer">
