                ...
                <div className="bg-white border border-off-white drop-shadow-2xl lg:w-[150rem] mb-16">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-1 overflow-hidden">
                        ...
                        {/* <MuxPlayer
                            ...
                            /> */}
                            {/* <MuxPlayerComponent {...props} playbackId={playbackId} /> */}
                            ...
                            {/* <MuxPlayerComponent playbackId="dOM00pqI022lCLHtNFaLn6r2KZ1aI01OstRGpqleqGV6r00" /> */}
                            {/* <MuxPlayerComponent playbackId="DBmBiBdlLIdzER7uLGQv7QVZL802qPu00KdbgOO9eBwfA" /> */}
                        </div>
                        <div className="flex-none lg:col-span-1 h-[27rem] overflow-hidden">
