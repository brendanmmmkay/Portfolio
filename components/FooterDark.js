            ...
            <div className='bg-hero-pattern3 bg-cover pt-6'>
                    <div className='pt-3 pb-6'>
                      ...
                      <h6 className="pt-20 font-SFproBold text-[14px] text-stone-600 uppercase tracking-[.15em]">competencies</h6> */}
                                                <h6 className="pt-20 font-AvenirHeavy text-[15px] text-stone-400 uppercase tracking-[.2em]">competencies</h6>
                                                {/* </div> */}
                                ...
                                Tools
                                                            ...
                                                            <Link href="/Brendan_McKay_Resume_2024.pdf" target="_blank" rel="noopener noreferrer">
                                                                ...
                                                                <Link href="/Brendan_McKay_Resume_2024.pdf" target="_blank" rel="noopener noreferrer"><h2 className="text-stone-300 font-Avenir  leading-relaxed gap-10 md:pl-10 pt-5">A degree in design at Simon Fraser University and 5 years of freelance work experience.</h2>
                                                                </Link>
