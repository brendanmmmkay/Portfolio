                                            ...
                                            <div className="grid w-full items-center pb-5">
                                                <div className="w-full justify-between flex space-x-2 flex-col md:flex-row">
                                                    ...
                                                    <div className=' drop-shadow-2xl  pb-3 text-3xl'>
                                                        ...
                                                        <h5 className="font-Avenir pt-2 text-stone-400 tracking-normal text-[1.1rem] leading-tight max-w-0.5 md:max-w-1 md:text-[1.4rem]">Available March 2024 for design opportunities.</h5>
                                                    </div>
                                                    {/* DIV 2 */}
                      ...
                      <h6 className="pt-20 font-SFproBold text-[14px] text-stone-600 uppercase tracking-[.15em]">competencies</h6> */}
                                ...
                                Tools
                                                        ...
                                                        <Link href="/Brendan_McKay_Resume_2024.pdf" target="_blank" rel="noopener noreferrer">
                                                            ...
                                                            <Link href="/Brendan_McKay_Resume_2024.pdf" target="_blank" rel="noopener noreferrer"><h2 className="text-stone-200 font-Avenir  leading-relaxed gap-10 md:pl-10 pt-5">A degree in design at Simon Fraser University and 5 years of freelance work experience.</h2>
                                                            </Link>
